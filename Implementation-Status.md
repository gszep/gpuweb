...
<sup>1</sup> For details, look at the [Dawn](https://crbug.com/dawn) and [Tint](https://crbug.com/tint) bug trackers and in the
    Chromium bug tracker's [WebGPU components](https://issues.chromium.org/savedsearches/6760928).
